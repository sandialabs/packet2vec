...
BOOST_AUTO_TEST_CASE( test_timestamp_conversion_short)
{
  std::string classification = "malicious";
  std::string timestamp = "2016-12-08T20:40:49.538Z";
  std::string protocol = "tcp";
  std::string sourceIp = "142.104.64.196";
  unsigned int sourcePort = 514;
  std::string destIp = "172.16.1.23";
  ...
  BOOST_CHECK_EQUAL(item.getTimestamp(), 1481229649538000);
}

BOOST_AUTO_TEST_CASE( test_timestamp_conversion_no_micro)
{
  std::string classification = "malicious";
  std::string timestamp = "2016-12-08T20:40:49Z";
  std::string protocol = "tcp";
  std::string sourceIp = "142.104.64.196";
  unsigned int sourcePort = 514;
  std::string destIp = "172.16.1.23";
  ...
  BOOST_CHECK_EQUAL(item.getTimestamp(), 1481229649000000);
}
